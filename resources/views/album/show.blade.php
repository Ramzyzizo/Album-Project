                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                @if(count($album->photos)>0)
                                    ...
                                    {{--                                loop on each photo --}}
                                    @php
                                        $photosChunks = array_chunk($album->photos->toArray(), 3);
                                    @endphp
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="cart_h d-flex flex-row align-items-center">
                                                                    <div>
                                                                        <img src="{{ asset('storage/'.$photo['path']) }}" class="img-fluid rounded-3" alt="{{$photo['name']}}" style="height: 120px;">
                                                                    </div>
                                                                    <div class="ms-3">
                                                                        <h5>{{ $photo['name'] }}</h5>
                                                                    </div>
